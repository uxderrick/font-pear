...
const home = () => {
	...
	useEffect(() => {
		document.body.style.backgroundColor = theme === "light" ? "#fff" : "#0d0d0d";
	}, [theme]);
				...
				<Flex className="layout " gap="9" justify="between" direction="column">
					...
					<Flex justify="between" align="center">
						...
						<Flex gap="5" align="center">
							...
							{theme === "light" ? (
								<MoonIcon height="25" width="25" onClick={toggleTheme} className="mouse "></MoonIcon>
							) : (
								<SunIcon height="25" width="25" onClick={toggleTheme} className="mouse " color="white"></SunIcon>
							)}
						</Flex>
					</Flex>
